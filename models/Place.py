...
class Place(BaseModel):
    ...
    if app.config['USE_DATABASE']:
        ...
        amenity_id: Mapped[list[String]] = mapped_column(list(Integer), ForeignKey("amenities.id"), nullable=True, unique=True)
        city_id: Mapped[String] = mapped_column(Integer, ForeignKey("cities.id"), nullable=True)
        host_id: Mapped[String] = mapped_column(Integer, ForeignKey("users.id"), nullable=True)
